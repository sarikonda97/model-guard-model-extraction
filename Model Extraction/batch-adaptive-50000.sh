...
#SBATCH --output=adaptive_50000.out  # %N for node name, %j for jobID
...
python ~/projects/def-guzdial/mohan235/CMPUT622_project/knockoffnets/batch_model_adaptive_50000.py